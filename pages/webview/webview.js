...
Page({
  ...
  onLoad: function (options) {
    ...
    var _url = 'http://localhost:8081/index.html#/Choose?token=' + app.globalData.token + '&weixinId=' + app.globalData.weixinId + "&mpType=5";
    // var _url = 'https://m.matafy.com/train_test/index.html#/Choose?token=' + app.globalData.token + '&weixinId=' + app.globalData.weixinId + "&mpType=5";
    ...
    if (options.path) {
      switch (options.path) {
        case '1':
          _url = 'https://m.matafy.com/wechatMp/index.html#/TrainChoose?mpToken=' + options.type + '&from=paySuccess&orderNo=' + options.orderNo
            + '&token=' + app.globalData.token + '&weixinId=' + app.globalData.weixinId + "&mpType=5";
          // _url = 'https://m.matafy.com/ticketsMpTest/index.html#/OrderDetail?sysPlatformType='+options.type+'&from=paySuccess&orderNo=' + options.orderNo
          //   + '&token=' + app.globalData.token + '&weixinId=' + app.globalData.weixinId + "&mpType=2";
          break;
        case '2':
          _url = _url
          break;
